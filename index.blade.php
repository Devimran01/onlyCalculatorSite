...
<div class="container my-5">
  ...
  <h2 class="mb-2 category-title">Finance Calculators</h2>
  ...
  <p class="mb-4 category-description">
      Our Finance Calculators are designed to help you monitor and improve your well-being. From tracking your Body Mass Index (BMI) to calculating heart rate zones, calorie needs, and more — these tools provide quick and accurate results to support a healthier lifestyle. Whether you're focusing on fitness, nutrition, or general wellness, our calculators make it easier to stay informed and make better health decisions.
  </p>
  ...
  <div class="row">
    <div class="col-md-6">
        <ul class="calculator-links">
            <li><a href="{{ url('/finance/discount-calculator') }}">Finance discount-calculator</a></li>
            <li><a href="{{ url('/finance/profit-margin-calculator') }}">Finance profit-margin-calculator</a></li>
            <li><a href="{{ url('/finance/annual-income-calculator') }}">Finance annual-income-calculator</a></li>
            <li><a href="{{ url('/finance/apy-calculator') }}">Finance apy-calculator</a></li>
            <li><a href="{{ url('/finance/expense-ratio-calculator') }}">Finance expense-ratio-calculator</a></li>
            <li><a href="{{ url('/finance/loan-calculator') }}"> Finance loan-calculator</a></li>
